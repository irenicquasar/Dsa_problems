...
class RedBlackTree:
    ...
    #this function is used to insert a node in the tree
    def insert(self, key):
        node = Node(key, 'red')
    ...
    #this function is used to transplant a node in the tree
    ...
    #this function is used to search a node in the tree
...
#this function is used to build the edges and colors dictionaries
...
if __name__ == '__main__':
    tree = RedBlackTree()
    l=[2,5,9,10,25,30,38,40]
    for i in l:
        tree.insert(i)   
    #to search for a node in the tree
    search=tree.search(4)
